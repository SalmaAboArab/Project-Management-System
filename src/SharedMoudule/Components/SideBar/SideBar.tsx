...
export default function SideBar() {
  ...
  const [handleSidebar, setHandleSidebar] = useState(() => {
    const storedValue = localStorage.getItem("toggleSidebar");
    if (storedValue === "true") {
      return true;
    } else {
      return false; 
  ...
  useEffect(() => {
    localStorage.setItem("toggleSidebar", handleSidebar);
  }, [handleSidebar]);
        ...
        >
          ...
          <MenuItem
            ...
            <MenuItem
              ...
              icon={
                isDarkMode === true ? (
                  <i className="fa-solid fa-toggle-on me-2 fs-3"></i>
                ) : (
                  <i className="fa-solid fa-toggle-off me-2 fs-3"></i>
                )
              }
            >
            ...
            <MenuItem
              icon={
                <i className="fa fa-arrow-right-from-bracket me-1 text-warning"></i>
              }
